...
#Declare model
model_ =keras.applications.nasnet.NASNetLarge(input_shape=None, include_top=True, weights='imagenet')
...
Y_pred = model.predict_generator(test_it, 5480 // batch_size)
y_pred = np.argmax(Y_pred, axis=1)
print('Confusion Matrix')
tn, fp, fn, tp =confusion_matrix(test_it.classes, y_pred)
print(tp)
print(tn)
print(fp)
print(fn)
